...
public class TC2_RegisterationScenariosAV extends BaseClass {
	...
	public void validInputRegisterationTestForPatients() {
		...
		//register.Registeration("sarikaqa7+virtual6@gmail.com",
		
		//no - sarikaqa7+ponyaccvir4@gmail.com
		...
		//https://eqcare.atlassian.net/browse/EQCARE-1240
				...
				DataProviderFactory.getExcel().getCellData("Users", 2, 10), true,"pdf");
	...
	public void validInputEnrolledRegisterationTestNotBCTest() {
