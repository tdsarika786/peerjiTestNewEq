...
public class NovaLoggedAction extends BaseClass {
	...
	public void LoggedAction(String searchemployer, String coveragetoken, String coveragetype)
		...
		home.LoggedAction("Calling", "Patient Calling EN", "Patinet Calling FR");

		System.out.println("*********1 LoggedAction ***********");
	}

	@Parameters({ "SearchEmployer", "CoverageToken", "CoverageType" })
	@Test(priority = 2, dependsOnMethods = "loginToApplication")
	public void LoggedAction1(String searchemployer, String coveragetoken, String coveragetype)
			throws InterruptedException {
		...
		home.LoggedAction("Appointment", "Patient Appointment EN", "Patinet Appointment FR");

		System.out.println("*********2 LoggedAction1 ***********");
	}
