...
public class HRAScoreKeepItUpSkipToTalk extends BaseClass {
	...
	public void verifyPage(String email, String password) throws Exception {
		...
		login.loginToApplication("sarikaqa7+anuemp3@gmail.com", "Sarika#123");
	...
	public void verifyTalkToCare(String coverage) throws Exception {
		...
		System.out.println("######### END HRAScoreKeepItUpSkipToTalk ###########");
