...
public class HRAIntroPageTalkCare extends BaseClass {
	...
	public void verifyPage(String email, String password) throws Exception {
		...
		login.loginToApplication("sarikaqa7+abc1@gmail.com", "Sarika#123");
		...
		System.out.println("########## START HRAIntroPageTalkCare ########## " + "sarikaqa7+abc1@gmail.com");
	...
	public void verifyTalkToCare(String coverage) throws Exception {
		...
		System.out.println("######### END HRAIntroPageTalkCare ###########");
