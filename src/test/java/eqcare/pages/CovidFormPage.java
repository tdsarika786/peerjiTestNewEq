...
public class CovidFormPage extends runWithAttachments {

	WebDriver driver;

	public CovidFormPage(WebDriver ldriver) {
		this.driver = ldriver;
	}
...
//	By termsCond = By.xpath("//*[@placeholder='Enter your phone number']");
	...
	public void EnrolledUserWithValidInput() {
		...
		// PEERJI
		Utility.waitForWebElement(driver, coverageIdentifierInput).sendKeys("24");
