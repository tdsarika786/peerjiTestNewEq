...
public class AccountPageAV extends runWithAttachments {

	WebDriver driver;

	public AccountPageAV(WebDriver ldriver) {
		this.driver = ldriver;
	}
...
//	By termsCond = By.xpath("//*[@placeholder='Enter your phone number']");
	...
	public void editUserAccountInfo() throws Exception {
		...
		try {
			...
			Utility.waitForWebElement(driver, address_2Input).sendKeys("Optional Address 2 A");
