...
public class LoginPageAV extends runWithAttachments {

	WebDriver driver;

	public LoginPageAV(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	public void AccessVirtualURL(String AVAppURL) {

		Utility.navigateToURL(driver, AVAppURL);
	}
