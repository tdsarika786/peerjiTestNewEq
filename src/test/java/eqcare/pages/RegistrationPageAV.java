...
public class RegistrationPageAV extends runWithAttachments {

	WebDriver driver;

	public RegistrationPageAV(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	By healthCardNumber = By.xpath("//*[@placeholder='Enter your BC Services Card number']");
...
//	By termsCond = By.xpath("//*[@placeholder='Enter your phone number']");
	...
	public void EnrolledUserWithValidInput() {
		...
		//1. Bell Test Sarika - Group NUMBER
		
		Utility.waitForWebElement(driver, groupNoInput).sendKeys("7710");

		Utility.waitForWebElement(driver, groupNumberLink).click();

		//2.  PEERJI - Coverage Token
		Utility.waitForWebElement(driver, coverageIdentifierInput).sendKeys("771");
