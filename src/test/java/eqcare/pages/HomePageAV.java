...
public class HomePageAV {
	...
	public HomePageAV(WebDriver ldriver) {
		this.driver = ldriver;
	}

	public void verifyUrl() {
		Assert.assertTrue(driver.getCurrentUrl().contains("quickseries"),
				"Home Page does not contain quickseries in url");
	}
