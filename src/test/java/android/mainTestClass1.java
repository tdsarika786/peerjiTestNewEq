...
class TestClass12 implements Runnable {
	public void run() {
		Hashtable<String, String> capsHashtable = new Hashtable<String, String>();
		capsHashtable.put("browser", "opera");
		capsHashtable.put("browser_version", "12.16");
		capsHashtable.put("os", "Windows");
...
class TestClass13 implements Runnable {
	public void run() {
		...
		capsHashtable.put("browser_version", "94.0 beta");
...
public class mainTestClass1 {
	public static final String USERNAME = "sarika57";
	public static final String AUTOMATE_KEY = "X2uuzkLHu1XMpyRJ3gaN";
	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
	public static void main(String[] args) throws Exception {
		Thread object1 = new Thread(new TestClass11());
		object1.start();
		Thread object2 = new Thread(new TestClass12());
		object2.start();
		Thread object3 = new Thread(new TestClass13());
		object3.start();
  	}
